...
public class ImageAdapter extends BaseAdapter {
    ...
    //crear un nuevo ImageView para cada elemento referenciado por el adaptador
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //Ejecute el código relacionado con la imagen después de que la vista haya sido diseñada.
